    ...
    <style>
        ...
        * {
        ...
        html, body {
            height: 100%;
            width: 100%;
           background-image: url("/images/User_h.jpeg");
...
<nav>
    ...
    <a href="<c:url value="/user/user-home/can"/>">Cancellation</a>
     <a href="<c:url value="/user/user-home/About"/>">About us</a>
       <a href="<c:url value="/user/user-home/help"/>">Help</a>
