...
//    @GetMapping("/user/user-home/cancel")
//    public ModelAndView cancellation() {
//        // Remove ticket session
//       // request.getSession().removeAttribute("ticket");
//        return new ModelAndView("user/user_home/cancel");
//    }
    
    @GetMapping("/user/user-home/can")
    public String cancellationbtn() {
        // Remove ticket session
       // request.getSession().removeAttribute("ticket");
        return "user/user_home/cancel";
    }
    
    //help
    @GetMapping("/user/user-home/help")
    public String helpnbtn() {
        // Remove ticket session
       // request.getSession().removeAttribute("ticket");
        return "user/user_home/help";
    }
       
    @GetMapping("/user/user-home/cancel/cancellation-successful")
    public String cancellationsucessfull(@RequestParam("bookingid") String bookingid,@RequestParam("flightbookingid") String flightbookingid)throws IndexOutOfBoundsException {
       	List<Booking> booking=cancel.findByFlightBookingIdAndFlightId(flightbookingid, bookingid);
       try {
    		if(booking.get(0)!=null) {
    	    	cancel.deleteBooking(bookingid);
    	    	cancel.deleteflightBooking(flightbookingid);
    	    	cancel.deletepassenger(bookingid);
    	    	 return "user/user_home/cancellation-successful";
    	    	}
	} catch (Exception e) {
    ...
    @GetMapping("/user/user-home/About")
    public String aboutus() {
        // Remove ticket session
       // request.getSession().removeAttribute("ticket");
        return "user/user_home/Aboutus";
    }
