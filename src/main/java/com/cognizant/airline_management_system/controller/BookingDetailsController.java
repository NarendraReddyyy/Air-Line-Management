...
public class BookingDetailsController {
    ...
    //feedback controller
    @GetMapping("/admin/admin/home/booking-details/feed/{bookingId}")
    public ModelAndView viewfeedback(
        ...
        List<feedback> feedbacks=feed.viewfeed(bookingId);
        try {
			if(feedbacks.get(0).getFeedback()!=null) {
				modelAndView.setViewName("admin/admin_home/booking_details/feedback");
				 modelAndView.addObject("feedbacks", feedbacks.get(0).getFeedback());
				 return modelAndView;
			}
		} catch (Exception e) {
			// TODO: handle exception
			 
	        modelAndView.setViewName("admin/admin_home/booking_details/nofeedback");
