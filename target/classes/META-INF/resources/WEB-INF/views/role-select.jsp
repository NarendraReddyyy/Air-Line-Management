	...
	<div class="content">
		<div class="card">
			<div class="container">
				...
				<div id="admin-login">
					<form:form action="/admin/admin-login" method="post"
				...
				<div id="user-login" hidden>
					<form:form action="/user/user-login" method="post"
						modelAttribute="userLogin">
						<form:label path="id">
							<spring:message code="label.user.id" />
						</form:label>
						<form:input path="id" type="number" id="user-id"
					...
					<div class="container-1">
						...
						<a href="<c:url value="/user/forget-password"/>">Forget
							Password?</a>
					</div>
				</div>
			</div>
					...
					<c:choose>
						<c:when test="${ not empty newsFeeds }">
							...
							<c:forEach var="newsFeed" items="${ newsFeeds }">
								<tr>
									<td><marquee width="100%" direction="left" height="30%">
											${ newsFeed.news }</marquee></td>
									<td>${ newsFeed.date }</td>
