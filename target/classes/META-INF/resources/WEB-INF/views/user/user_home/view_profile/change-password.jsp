...
html, body {
	height: 100%;
	width: 100%;
	background-image: url("/images/view-profile.jpeg");
	...
	<div class="content">
		<div class="card">
			<div class="container">
				...
				<form:form action="/user/user-home/view-profile/change-password"
					method="post" modelAttribute="userChangePassword">
